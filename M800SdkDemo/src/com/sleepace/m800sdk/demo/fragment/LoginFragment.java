...
public class LoginFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		m800Helper = M800Helper.getInstance(mActivity.getApplicationContext());
...
//		String serverHost = mSetting.getString("serverHost", "http://172.14.1.100:8091");
	...
	public void onClick(View v) {
		...
		if (v == btnConnect) {
			...
			m800Helper.upgradeDevice(deviceVersion, MainActivity.deviceType, MainActivity.deviceId, new IResultCallback<Integer>() {
				@Override
							...
							if(cd.isSuccess()) {
								...
								for(int i=0; i<size; i++) {
									...
									if(DeviceType.isM800(dType)) {
										...
										initSide();
										m800Helper.login(ip, port, sid, deviceId, loginCallback);
										break;
									}else {
